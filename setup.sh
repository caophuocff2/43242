...
echo ""
echo -e "\e[1;33msu -c \"export PATH=\$PATH:/data/data/com.termux/files/usr/bin && export TERM=xterm-256color && cd /storage/emulated/0/Download && kotlinc -script main.kts\"\e[0m"
echo "=========================================="
